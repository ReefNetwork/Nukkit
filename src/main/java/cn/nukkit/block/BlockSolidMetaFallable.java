 ...
 * Nukkit Project
 */
public abstract class BlockSolidMetaFallable extends BlockSolidMeta {

    protected BlockSolidMetaFallable(int meta) {
        super(meta);
    }

    public int onUpdate(int type) {
        if (type == Level.BLOCK_UPDATE_NORMAL && level.getFolderName().equals("dig_1")) {
